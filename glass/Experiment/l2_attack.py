...
def pgd2(model, X, y, epsilon=0.5, alpha=0.01, num_iter=20, randomize=False, restarts = 1):
    """ Construct l2 adversarial examples on the examples X
    """
    model.eval()
    mean = torch.Tensor(np.array([129.1863, 104.7624, 93.5940])).view(1, 3, 1, 1)  # mean of the 
